                    ...
                    <form class="col-md-6" action="/admin/cms/menu{{isset($content) ? '/'.$content[0]->id : ''}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                <option value="nav" {{ isset($content) ? ($content[0]->type == 'nav' ? 'seletect' : '') : (app('request')->input('type') == 'nav' ? 'selected' : '') }}>Main menu</option>
                                <option value="footer" {{ isset($content) ? ($content[0]->type == 'footer' ? 'seletect' : '') : (app('request')->input('type') == 'footer' ? 'selected' : '') }}>Footer menu</option>
                            </select>
                        </div>
